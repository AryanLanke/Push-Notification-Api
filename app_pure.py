"""
Notification Delivery API (Pure Backend)

Flask REST API for push notification delivery.
Pure backend version - no frontend dependencies, JSON only.
...
# ============================================================================
# API ENDPOINTS (Pure JSON REST API)
# ============================================================================
...
def api_info():
    ...
    return jsonify({
        ...
        "endpoints": {
            ...
            "POST /notifications/send": "Send notification to devices",
...
def not_found(error):
    ...
    return jsonify({
        ...
        "hint": "Check the URL and HTTP method. Use GET /api for available endpoints."
    }), 404
...
if __name__ == "__main__":
    ...
    if os.environ.get("WERKZEUG_RUN_MAIN") != "true":
        print("=" * 60)
        print("NOTIFICATION DELIVERY API (Pure Backend)")
        print("=" * 60)
